...
func TestService_UpdateAccountNote(t *testing.T) {
	tests := []struct {
		...
		{name: "ok", mockResp: &client.APIResponse{StatusCode: 200}, mockBody: []byte(`{"note":{"id":"n1"}}`), noteID: "n1", req: &AccountNoteRequest{Note: map[string]interface{}{"note": "updated"}}, wantStatus: 200},
	}
