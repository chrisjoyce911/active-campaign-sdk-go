...
func Test_UpdateListStatusManaged_SkipWhenUnsubscribedAndNotForce(t *testing.T) {
	...
	req := &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("c1"), List: ListID("l1"), Status: 1}, Force: false}
...
func Test_UpdateListStatusManaged_ForceWhenUnsubscribed(t *testing.T) {
	...
	req := &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("c1"), List: ListID("l1"), Status: 1}, Force: true}
	out, apiResp, err := svc.UpdateListStatusManaged(context.Background(), req)
	assert.NoError(t, err)
	assert.NotNil(t, apiResp)
	_ = out
...
func Test_UpdateListStatusManaged_CreateWhenNotPresent(t *testing.T) {
	...
	req := &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("c1"), List: ListID("l2"), Status: 1}, Force: false}
...
func Test_UpdateListStatusManaged_NoOpWhenAlreadySubscribed(t *testing.T) {
	...
	req := &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("c1"), List: ListID("l1"), Status: 1}}
	out, apiResp, err := svc.UpdateListStatusManaged(context.Background(), req)
	assert.NoError(t, err)
	assert.Nil(t, out)
	assert.NotNil(t, apiResp)
...
func Test_UpdateListStatusManaged_DefaultDesiredStatusWhenEmpty(t *testing.T) {
	...
	req := &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("c9"), List: ListID("l9"), Status: 0}, Force: false}
	_, apiResp, err := svc.UpdateListStatusManaged(context.Background(), req)
	assert.NoError(t, err)
	assert.NotNil(t, apiResp)
	if assert.NotNil(t, hd.LastRequest) {
...
func Test_UpdateListStatusManaged_ErrorsAndValidation(t *testing.T) {
	...
	svc = NewRealServiceFromDoer(hd)
	out, apiResp, err = svc.UpdateListStatusManaged(context.Background(), &UpdateListStatusHelperRequest{ContactList: &ContactList{Contact: ContactID("121"), List: ListID("25"), Status: 1}})
	assert.Error(t, err)
	assert.Nil(t, out)
